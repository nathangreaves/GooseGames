...
import { AvalonComponentBase } from '../../../models/avalon/content';
import { GlobalSessionService } from '../../../services/session';

@Component({
  selector: 'avalon-landing-component',
  templateUrl: './landing.component.html'
})
export class AvalonLandingComponent extends AvalonComponentBase {
  ...
  public EnterGame() {
    ...
    if (this.ReadSessionData(this.SessionIdentifier)) {
      this._router.navigate(['/avalon', this.SessionIdentifier]);
    }
    else {
