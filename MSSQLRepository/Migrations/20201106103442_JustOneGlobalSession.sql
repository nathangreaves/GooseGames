...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[PlayerStatuses] DROP CONSTRAINT [FK_PlayerStatuses_Players_PlayerId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[Responses] DROP CONSTRAINT [FK_Responses_Players_PlayerId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[ResponseVotes] DROP CONSTRAINT [FK_ResponseVotes_Players_PlayerId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[Rounds] DROP CONSTRAINT [FK_Rounds_Players_ActivePlayerId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[Rounds] DROP CONSTRAINT [FK_Rounds_Sessions_SessionId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[Players] DROP CONSTRAINT [FK_Players_Sessions_SessionId];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DROP INDEX [IX_Rounds_ActivePlayerId] ON [JustOne].[Rounds];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DROP INDEX [IX_Rounds_SessionId] ON [JustOne].[Rounds];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DROP INDEX [IX_ResponseVotes_PlayerId] ON [JustOne].[ResponseVotes];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DROP INDEX [IX_Responses_PlayerId] ON [JustOne].[Responses];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DROP INDEX [IX_PlayerStatuses_PlayerId] ON [JustOne].[PlayerStatuses];
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DELETE FROM JustOne.ResponseVotes
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    DELETE FROM JustOne.PlayerStatuses
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[Rounds] ADD [GameId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[PlayerStatuses] ADD [ConnectionId] nvarchar(max) NULL;
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[PlayerStatuses] ADD [GameId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
END;
...
BEGIN
    CREATE TABLE [JustOne].[Games] (
        ...
        CONSTRAINT [FK_Games_Rounds_CurrentRoundId] FOREIGN KEY ([CurrentRoundId]) REFERENCES [JustOne].[Rounds] ([Id]) ON DELETE NO ACTION
    );
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    CREATE INDEX [IX_Rounds_GameId] ON [JustOne].[Rounds] ([GameId]);
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    CREATE INDEX [IX_Games_CurrentRoundId] ON [JustOne].[Games] ([CurrentRoundId]);
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20201106103442_JustOneGlobalSession')
BEGIN
    ALTER TABLE [JustOne].[Rounds] ADD CONSTRAINT [FK_Rounds_Games_GameId] FOREIGN KEY ([GameId]) REFERENCES [JustOne].[Games] ([Id]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20201106103442_JustOneGlobalSession', N'3.1.3');
END;
